import { useAddProductMutation, useUpdateProductMutation, useUploadImageMutation } from '@/app/api/ProductsApiSlice';
import { IsProductOpenSelector, toggleIsProductOpen } from '@/app/features/ProductSlice';
...
const ProductModal = ({ mode, id, withButton = false }: ProductModalProps) => {
    ...
    return (
        ...
        rounded-lg relative overflow-hidden group"
                    onClick={() => dispatch(toggleIsProductOpen(!isOpen))}
                >
