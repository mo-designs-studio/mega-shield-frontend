  ...
  return (
    <>
      ...
      <Table className="font-arabic my-5 min-w-[767px]">
        ...
        <TableBody>
          {mode === "main-services" && items && items.length > 0
            ? items.map((item, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell>
                    <img src={`${serverdUrl}${item.photo}`} alt="service-photo" className="w-[250px] sm:m-3" />
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-start justify-center gap-3 flex-col">
                      {item.description.map((feature, i) => (
                        <span key={i} className={i !== item.description.length - 1 ? "border-b border-solid border-primary pb-3" : ""}>
                          {feature}
                        </span>
                      ))}
                    </div>
