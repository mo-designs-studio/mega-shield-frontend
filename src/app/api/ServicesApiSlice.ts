...
const ServicesApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        // AddMainService: builder.mutation<void, MainServiceProps>({
        //     query: (arg) => ({
        ...
        //     invalidatesTags: ['mainServices'],
        // }),
        // DeleteMainService: builder.mutation<void, { id: string }>({
        //     query: (arg) => ({
        ...
        //     invalidatesTags: ['mainServices', 'subServices'],
        // }),
        // UpdateSubService: builder.mutation<any, { id: string; props: Partial<Service> }>({
        //     query: (args) => ({
